...
```{r}
d_outcome <- filter(d_outcome, MeasureId== 'BPHIGH'| MeasureId== 'DEPRESSION'| MeasureId== 'DIABETES' | MeasureId== 'HIGHCHOL'| MeasureId== 'OBESITY')
```
...
```{r}
d_new <- gather(d_new, key = "predictor", value = "predictor_value", 12:17)
```
